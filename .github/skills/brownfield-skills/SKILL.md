...
Generate VS Code + GitHub Copilot Project Skills for **brownfield (existing) projects**.
...
2. Generated Skills are placed in `.github/skills/brownfield-developer-[project-name]/`
3. GitHub Copilot can use these Skills when referenced from `.github/copilot-instructions.md`
...
| Check | Correct | Wrong |
|-------|---------|-------|
| Skills root | `.github/skills/` | `skills/` |
